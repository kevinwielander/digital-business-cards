    ...
    // --- PORTRAIT TEMPLATES (mobile-first, show first) ---
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 20, y: 240, width: 280, height: 30, boundField: "full_name_with_titles", fontSize: 22, fontWeight: "bold", color: "#1a1a1a", textAlign: "center", zIndex: 2 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 24, y: 220, width: 272, height: 28, boundField: "full_name_with_titles", fontSize: 22, fontWeight: "bold", color: "#ffffff", zIndex: 3 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 30, y: 150, width: 260, height: 28, boundField: "full_name_with_titles", fontSize: 24, fontWeight: "bold", color: "#0f172a", fontFamily: "Georgia, serif", zIndex: 2 }),
    ...
    // --- LANDSCAPE TEMPLATES ---
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 24, y: 105, width: 300, height: 30, boundField: "full_name_with_titles", fontSize: 22, fontWeight: "bold", color: "#ffffff", textShadow: "0 1px 2px rgba(0,0,0,0.2)", zIndex: 3 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 200, y: 70, width: 230, height: 30, boundField: "full_name_with_titles", fontSize: 20, fontWeight: "bold", color: "#0f172a", zIndex: 3 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 110, y: 30, width: 280, height: 30, boundField: "full_name_with_titles", fontSize: 22, fontWeight: "bold", color: "#ffffff", zIndex: 3 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 20, y: 230, width: 240, height: 30, boundField: "full_name_with_titles", fontSize: 20, fontWeight: "600", color: "#1a1a1a", textAlign: "center", fontFamily: "Georgia, serif", zIndex: 3 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 185, y: 28, width: 245, height: 32, boundField: "full_name_with_titles", fontSize: 24, fontWeight: "bold", color: "#0f172a", zIndex: 3 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                el({ id: "t1", type: "text", x: 32, y: 32, width: 290, height: 34, boundField: "full_name_with_titles", fontSize: 26, fontWeight: "bold", color: "#451a03", fontFamily: "Georgia, serif", zIndex: 3 }),
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                // Name
                el({ id: "t1", type: "text", x: 24, y: 80, width: 300, height: 34, boundField: "full_name_with_titles", fontSize: 26, fontWeight: "bold", color: "#ffffff", textShadow: "0 2px 4px rgba(0,0,0,0.3)", zIndex: 4 }),
                // Title
    ...
    },
    {
        ...
        config: {
            ...
            elements: [
                ...
                // Name
                el({ id: "t1", type: "text", x: 100, y: 24, width: 200, height: 28, boundField: "full_name_with_titles", fontSize: 20, fontWeight: "bold", color: "#0f172a", zIndex: 3 }),
                // Title
